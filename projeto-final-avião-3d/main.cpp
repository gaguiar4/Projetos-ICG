...
Image * loadTexture(int id){
    ...
    switch(id){
        case 0:
            if (!ImageLoad("C:\\Users\\Gabriel\\Desktop\\aviaoem3d\\stone.bmp", image1)) {
                exit(1);
            }break;
        case 1:
            if (!ImageLoad("C:\\Users\\Gabriel\\Desktop\\aviaoem3d\\aviao.bmp", image1)) {
                exit(1);
            }break;
        case 2:
            if (!ImageLoad("C:\\Users\\Gabriel\\Desktop\\aviaoem3d\\gameover.bmp", image1)) {
                exit(1);
            }break;
    }
    return image1;
